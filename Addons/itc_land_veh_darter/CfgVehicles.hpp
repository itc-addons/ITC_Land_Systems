class CfgVehicles {
    ...
    class CAManBase: Man {
        class ACE_SelfActions {
            class TB_UnpackDarter {
                ...
                showDisabled = 0;
                priority = 0;
                class TB_Unpack_AR2_B {
                    displayName = "AR-2 Darter [NATO]";
                    condition = "'TB_B_UAV_Packed' in (items _player)";
                    statement = "['TB_B_UAV_Packed',_player] call itc_land_veh_darter_fnc_unPackUAV";
                    priority = 1;
                    showDisabled = 1;
					exceptions[] = {"isNotInside","isNotSitting"};
                    enableInside = 0;
                };
                class TB_Unpack_AR2_O: TB_Unpack_AR2_B {
                    displayName = "AR-2 Tayran [CSAT]";
                    condition = "'TB_O_UAV_Packed' in (items _player)";
                    statement = "['TB_O_UAV_Packed',_player] call itc_land_veh_darter_fnc_unPackUAV";
                };
                class TB_Unpack_AR2_I: TB_Unpack_AR2_B {
                    displayName = "AR-2 Darter [AAF]";
                    condition = "'TB_I_UAV_Packed' in (items _player)";
                    statement = "['TB_I_UAV_Packed',_player] call itc_land_veh_darter_fnc_unPackUAV";
                };
                class TB_Unpack_AR2i_B: TB_Unpack_AR2_B {
                    displayName = "AR-2i Darter 2 [NATO]";
                    condition = "'TB_B_AR2i_Packed' in (items _player)";
                    statement = "['TB_B_AR2i_Packed',_player] call itc_land_veh_darter_fnc_unPackUAV";
                };
                class TB_Unpack_AR2i_O: TB_Unpack_AR2_B {
                    displayName = "AR-2i Tayran 2 [CSAT]";
                    condition = "'TB_I_AR2i_Packed' in (items _player)";
                    statement = "['TB_I_AR2i_Packed',_player] call itc_land_veh_darter_fnc_unPackUAV";
                };
                class TB_Unpack_AR2i_I: TB_Unpack_AR2_B {
                    displayName = "AR-2i Darter 2 [NATO]";
                    condition = "'TB_I_AR2i_Packed' in (items _player)";
                    statement = "['TB_I_AR2i_Packed',_player] call itc_land_veh_darter_fnc_unPackUAV";
                };
	...
	class TB_UAV_AR2i_base: UAV_01_base_F {
        class Turrets: Turrets {
            class MainTurret: MainTurret {
                    turretInfoType = "TB_AR2I_RscOptics_UAV_gunner";
            };
        };
    };


	class TB_B_UAV_AR2i: TB_UAV_AR2i_base {
		author = "Toadball";
		displayName = "AR-2i Darter 2";
		itc_land_darter_PacksTo = "TB_B_AR2i_Packed";
		class SimpleObject {
			eden = 1;
	...
	class TB_O_UAV_AR2i: TB_UAV_AR2i_base {
		author = "Toadball";
		displayName = "AR-2i Tayran 2";
		itc_land_darter_PacksTo = "TB_O_AR2i_Packed";
		class SimpleObject {
			eden = 1;
			animate[] = {{"damagehide", 0}, {"rotorimpacthide", 0}, {"tailrotorimpacthide", 0}, {"propeller1_rotation", 1}, {"propeller1_blur_rotation", 1}, {"propeller2_rotation", 0}, {"propeller2_blur_rotation", 0}, {"propeller3_rotation", 1}, {"propeller3_blur_rotation", 1}, {"propeller4_rotation", 0}, {"propeller4_blur_rotation", 0}, {"propeller1_hide", 0}, {"propeller1_blur_hide", 0}, {"propeller2_hide", 0}, {"propeller2_blur_hide", 0}, {"propeller3_hide", 0}, {"propeller3_blur_hide", 0}, {"propeller4_hide", 0}, {"propeller4_blur_hide", 0}, {"mainturret", 0}, {"maingun", -0.05}};
			hide[] = {"zasleh", "light_r", "tail rotor blur", "main rotor blur", "zadni svetlo", "clan", "podsvit pristroju", "poskozeni"};
	...
	class TB_I_UAV_AR2i: TB_UAV_AR2i_base {
		author = "Toadball";
		displayName = "AR-2i Darter 2";
	...
	class B_UAV_01_F: UAV_01_base_F {
		itc_land_darter_PacksTo = "TB_B_UAV_Packed";
		class assembleInfo {
			primary = 1;
			base = "";
			assembleTo = "";
	...
	class O_UAV_01_F: UAV_01_base_F {
		itc_land_darter_PacksTo = "TB_O_UAV_Packed";
		class ACE_Actions: ACE_Actions {
			class ACE_MainActions: ACE_MainActions {
				class TB_PackDarter {
					displayName = "Repack UAV";
	...
	class Bag_Base;	
	class tb_uav_ar2i_backpack_base: Bag_Base {
			author = "Toadball";
	...
	class tb_b_uav_ar2i_backpack: tb_uav_ar2i_backpack_base {
			author = "Toadball";
			displayName = "UAV Bag (AR-2i) [NATO]";
			scope = 2;
			scopeCurator = 2;
			...
			class TransportItems {		
				class _xx_TB_B_AR2i_Packed {
					count = 2;
					name = "TB_B_AR2i_Packed";
				};
	...
	class tb_i_uav_ar2i_backpack: tb_uav_ar2i_backpack_base {
			author = "Toadball";
			...
			class TransportItems {		
				class _xx_TB_I_AR2i_Packed {
					count = 2;
					name = "TB_I_AR2i_Packed";
				};
	...
	class tb_o_uav_ar2i_backpack: tb_uav_ar2i_backpack_base {
			author = "Toadball";
			...
			class TransportItems {		
				class _xx_TB_O_AR2i_Packed {
					count = 2;
					name = "TB_O_AR2i_Packed";
				};
