class ITC_Land_RscOptics_GLTD_gunner: RscOptics_strider_commander {
  onLoad = "uiNamespace setVariable ['ITC_Land_RscOptics_GLTD_gunner', _this select 0]; ['itc_land_onLoad_RscOptics_GLTD_gunner', []] call CBA_fnc_localEvent;";
  onUnload = "uiNameSpace setVariable ['ITC_Land_RscOptics_GLTD_gunner',nil];";
  idd = 512;
  controls[] = {"ITC_Land_GLTD_IGUI_elements_group"};
  class ITC_Land_GLTD_IGUI_elements_group: CA_IGUI_elements_group {
    idc = 75001;
    ...
    class controls {
      ...
      class ITC_Land_LaserCode: RscText {
        idc = 75021;
        style = 2;
