class ITC_Land_RscOptics_UAV_gunner: RscOptics_UAV_gunner {
  onLoad = "uiNamespace setVariable ['ITC_Land_RscOptics_UAV_gunner', _this select 0]; ['itc_land_onLoad_RscOptics_UAV_gunner', []] call CBA_fnc_localEvent;";
  controls[] = {"ITC_Land_UAVi_IGUI_elements_group"};
  idd = 512;
  class ITC_Land_UAVi_IGUI_elements_group: CA_IGUI_elements_group {
    idc = 75001;
