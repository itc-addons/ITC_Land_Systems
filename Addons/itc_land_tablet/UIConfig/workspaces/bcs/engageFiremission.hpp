class page_bcs_firemission_engage:itc_land_workspace
{
  ...
  class Controls {
    ...
    class itc_land_engagement_sheaf_input: ITC_ARTY_RscComboBox
    {
        idc = 7101;
        x = 0.427812 * safezoneW + safezoneX;
        y = 0.357 * safezoneH + safezoneY;
    ...
    class itc_land_engagement_quick_text: ITC_ARTY_RscText
    {
        idc = 7020;
    ...
    class itc_land_engagement_quick_input: ITC_ARTY_RscComboBox
    {
        idc = 7401;
        x = 0.427812 * safezoneW + safezoneX;
        y = 0.379 * safezoneH + safezoneY;
    ...
    class itc_land_engagement_direction_text: ITC_ARTY_RscText
    {
        idc = 7021;
    ...
    class itc_land_engagement_direction_input: ITC_ARTY_RscTextBox
    {
        idc = 7402;
    ...
    class itc_land_engagement_length_text: ITC_ARTY_RscText
    {
        idc = 7022;
    ...
    class itc_land_engagement_length_input: ITC_ARTY_RscTextBox
    {
        idc = 7403;
        text = "0"; //--- ToDo: Localize;
        x = 0.427812 * safezoneW + safezoneX;
