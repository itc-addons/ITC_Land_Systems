...
#define EMPTYMISSION(IDENT) [IDENT, "newMission",[0,-1,"0","0","0","0",[0,0,0]],["Parallel","ON",0,0], 0, 0];
...
#define MISSIONPARAMS _mission params ["_ident", "_page","_targetPage","_engagePage", "_curSolution", "_solutionLimit"]; \
_targetPage params ["_targetTypeIndex","_kpi","_in0","_in1","_in2","_in3","_tgtPos"]; \
_engagePage params ["_sheafType","_quick","_sheafdir","_sheaflength"]
